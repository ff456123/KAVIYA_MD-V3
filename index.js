...
let up = `🚀 _KAVIYA_MD V3 Connected Successfully!_ ✅ 
...
🖇️Subscribe My Youtube Channel✓💗 :https://youtube.com/@slkaviyabro?si=CwswjKM5E5RgpyaJ
...
if (config.AUTO_BIO === 'true'){
               await
conn.updateProfileStatus(`𝗞𝗔𝗩𝗜𝗬𝗔_𝗠𝗗 𝗩3💗 𝗦𝘂𝗰𝗰𝗲𝘀𝗳𝘂𝗹𝗹𝘆 𝗖𝗼𝗻𝗻𝗲𝗰𝘁𝗲𝗱➤ 𝗧𝗵𝗶𝘀 𝗗𝗲𝘃𝗶𝗰𝗲 𝗜𝘁 𝗛𝗮𝘃𝗲 𝗕𝗲𝗲𝗻 𝗥𝘂𝗻𝗻𝗶𝗻𝗴 𝗙𝗼𝗿 ⚡💻`)
 }
...
app.get("/", (req, res) => {
res.send("hey,KAVIYA_MD V3 bot started✅");
});
